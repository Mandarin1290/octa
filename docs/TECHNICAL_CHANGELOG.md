...
```
+   12 -    0  .dockerignore
+    9 -   10  octa/infra/deployment/docker/Dockerfile
```


## [2026-04-19 10:34:42] CHANGE
Code-Änderungen - (+7/-3 Zeilen)
...
**File-Level Changes:**
```
+    7 -    3  .github/workflows/build_and_push_image.yml
```


## [2026-04-19 10:15:00] CHANGE
Code-Änderungen - (+42/-5 Zeilen)
...
**File-Level Changes:**
```
+   42 -    5  .github/workflows/build_and_push_image.yml
```
...
+   13 -    0  scripts/promote_model_canary.py
```
...
**File-Level Changes:**
```
+  141 -   25  configs/sweep_catboost_1d.yaml
+    6 -    0  octa/core/features/features.py
+  518 -    0  octa/core/features/features_1h.py
+   10 -    0  octa_training/core/config.py
+   27 -    0  octa_training/core/pipeline.py
```
...
**File-Level Changes:**
```
+    2 -    2  octa/core/features/features.py
```


## [2026-04-04 14:12:12] CHANGE
Code-Änderungen - 1 Code-Dateien - (+12/-4 Zeilen)
...
**File-Level Changes:**
```
+   12 -    4  octa/core/features/features.py
```
...
**File-Level Changes:**
```
+   43 -    7  octa_ops/autopilot/paper_runner.py
+  142 -    0  scripts/octa_promote_models.py
+    3 -    2  tests/test_p1_fill_reconciliation.py
```
...
**File-Level Changes:**
```
+   91 -    2  octa_ops/autopilot/paper_runner.py
+   52 -    3  octa_vertex/broker/ibkr_ib_insync.py
+    9 -    4  tests/test_canonical_orchestration.py
+  403 -    0  tests/test_p1_fill_reconciliation.py
```
...
**File-Level Changes:**
```
+   18 -   10  configs/dev.yaml
+   19 -    1  configs/p03_research.yaml
+   30 -   13  tests/test_cascade_splits_per_tf.py
```


## [2026-03-31 16:52:19] CHANGE
Code-Änderungen - 1 Code-Dateien - (+7/-2 Zeilen)
...
**File-Level Changes:**
```
+    7 -    2  octa_training/core/pipeline.py
```
...
**File-Level Changes:**
```
+    1 -    0  octa/core/data/builders/__init__.py
+  245 -    0  octa/core/data/builders/futures_1d_regen.py
+  141 -    0  scripts/rebuild_futures_1d.py
+  189 -    0  tests/test_futures_1d_regen.py
```
...
**File-Level Changes:**
```
+   31 -    0  octa_ops/autopilot/universe.py
+    1 -    0  scripts/octa_autopilot.py
+   74 -    0  tests/test_multiasset_index_wiring.py
```
...
**File-Level Changes:**
```
+    2 -    3  configs/autopilot_daily.yaml
```
...
**File-Level Changes:**
```
+   17 -    0  octa/execution/runner.py
+   54 -    0  octa/execution/tws_probe.py
+  241 -    0  tests/test_i7_tws_probe.py
```
